...
import u7.joptionpane.JOptionPaneUtil;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!"Sair".equals(opcao)) {
            ...
            opcao = JOptionPaneUtil.exibirJanelaDeOpcoesLista("Banco POO: Operações",
                    cabecalho + "\n\nSelecione uma das operações abaixo:", opcoes).toString();
